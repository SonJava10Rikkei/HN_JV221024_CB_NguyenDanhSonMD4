...
('S004', 'Đỗ Tiến Mạnh', '1999-3-26', 1, 'Hà Nội', '0983665353'),
('S005', 'Phạm Duy Nhất', '1998-10-4', 1, 'Tuyên Quang', '0987242678'),
('S006', 'Mai Văn Thái', '2002-6-22', 1, 'Nam Định', '0982654268'),
('S007', 'Giang Gia Hân', '1996-10-11', 0, 'Phú Thọ', '0982364753'),
('S008', 'Nguyễn Ngọc Bảo My', '1999-1-2', 0, 'Hà Nam', '0927867453'),
('S009', 'Nguyễn Tiến Đạt', '1998-8-7', 1, 'Tuyên Quang', '0989274673'),
...
select s.studentId 'Mã Học Sinh',
 s.studentName 'Tên Học Sinh',
 (year(curdate())-year(s.birthday)) 'Tuổi', 
 if(s.gender=1,"Nam","Nữ") 'Giới Tính', 
 s.address 'Quê Quán' from student s;
